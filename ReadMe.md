...
This repository contains the robot code for our Spring 2026 Mentor's Prototype. 
...
2. Fork a copy of the main repository in GitHub
   - Go to https://github.com/rrmcmurry/2026ProtoMentors
   - Click on the button that says Fork in the upper right corner
   - This should make a copy of 2026ProtoMentors in your own GitHub account.
3. Clone your forked GitHub repository locally in VS Code:
   ...
   - https://github.com/YOURUSERNAME/2026ProtoMentors.git
4. Verify the setup:
